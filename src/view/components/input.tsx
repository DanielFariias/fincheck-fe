    ...
    return (
      <div className="relative">
        <input
          ...
          name={name}
          className={cn(
            'bg-white w-full rounded-lg border placeholder-shown:pt-0 pt-4 border-gray-500 px-3 h-[52px] text-gray-800 focus:border-gray-800 outline-none transition-all peer',
